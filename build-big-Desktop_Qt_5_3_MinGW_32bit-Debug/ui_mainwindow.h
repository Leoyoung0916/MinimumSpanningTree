...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        verticalLayoutWidget->setGeometry(QRect(420, 20, 164, 124));
        ...
        bigger = new QPushButton(verticalLayoutWidget);
        bigger->setObjectName(QStringLiteral("bigger"));
        QFont font1;
        font1.setFamily(QString::fromUtf8("\345\276\256\350\275\257\351\233\205\351\273\221"));
        bigger->setFont(font1);

        verticalLayout->addWidget(bigger);

        smaller = new QPushButton(verticalLayoutWidget);
        smaller->setObjectName(QStringLiteral("smaller"));
        smaller->setFont(font1);

        verticalLayout->addWidget(smaller);
        ...
        QObject::connect(bigger, SIGNAL(clicked()), action_bigger, SLOT(trigger()));
        QObject::connect(smaller, SIGNAL(pressed()), action_smaller, SLOT(trigger()));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        bigger->setText(QApplication::translate("MainWindow", "\346\224\276\345\244\247", 0));
        smaller->setText(QApplication::translate("MainWindow", "\347\274\251\345\260\217", 0));
